...
RSpec.describe "job_profiles/new", type: :view do
  before(:each) do
    assign(:job_profile, JobProfile.new(
      post_title_id: 1,
      core: "MyString",
      salary_level_id: 1,
      post_id: 1,
  ...
  it "renders new job_profile form" do
    render

    assert_select "form[action=?][method=?]", job_profiles_path, "post" do
